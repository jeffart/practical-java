...
import com.course.praticaljava.entity.Engine;
import com.course.praticaljava.entity.Tire;
...
public class RandomCarService implements CarService {
  ...
  public Car generateCar() {
    ...
    var horserPower = ThreadLocalRandom.current().nextInt(100, 221);
    var engine = new Engine();
    engine.setFuelType(fuel);
    engine.setHorserPower(horserPower);
    ...
    for (int i = 0; i < 3; i++) {
      ...
      var size = ThreadLocalRandom.current().nextInt(15, 22);
